...
int mem_init(void *pool_start, size_t pool_length)
{
	...
	// -> ya ubique estas 2 secciones y tengo las direcciones
	// data_base = pool_base + bm_bytes_al + rl_bytes_al; // direccion de primera de las paginas entregables (no usada)
